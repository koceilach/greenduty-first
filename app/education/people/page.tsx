                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <Link
                          ...
                          className="text-xs font-semibold hover:text-[#1E7F43] sm:text-sm"
                        >
    ...
    <div className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-white p-3 shadow-sm transition hover:shadow-md dark:border-slate-800 dark:bg-slate-900 sm:gap-3 sm:rounded-2xl sm:p-4">
      ...
      <div className="min-w-0 flex-1">
        <Link
          ...
          className="block truncate text-xs font-semibold text-slate-900 hover:text-[#1E7F43] dark:text-slate-100 sm:text-sm"
        >
          {person.fullName}
        </Link>
