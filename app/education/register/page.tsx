        ...
        {Array.from({ length: 4 }).map((_, i) => (
          <div
            ...
            className={`h-1 flex-1 rounded-full transition-all duration-300 ${
              i < score ? strengthColor[score - 1] : "bg-slate-200 dark:bg-slate-700"
            }`}
          />
        ))}
      </div>
      <p className="text-[10px] text-slate-400">{strengthLabel[score - 1] ?? "Too short"}</p>
    </div>
  );
}
  ...
  return (
    <div className="text-center">
      ...
      <Link
        ...
        className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#1E7F43] to-emerald-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition hover:shadow-xl"
      >
        Go to Sign in
      </Link>
    </div>
              ...
              <>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        autoComplete="new-password"
                        className={`w-full rounded-xl border bg-white/60 py-3 pl-10 pr-4 text-sm text-slate-800 outline-none transition placeholder:text-slate-400 focus:ring-2 dark:bg-slate-800/60 dark:text-slate-100 ${
                          confirmPassword && confirmPassword !== password
                            ? "border-red-300 focus:border-red-400 focus:ring-red-200/20 dark:border-red-700"
                            : "border-slate-200 focus:border-[#1E7F43] focus:ring-[#1E7F43]/20 dark:border-slate-700"
                        }`}
                      />
                    </div>
                    {confirmPassword && confirmPassword !== password && (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="relative mt-1 w-full overflow-hidden rounded-xl bg-gradient-to-r from-[#1E7F43] to-emerald-500 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition hover:shadow-xl hover:shadow-emerald-500/30 disabled:opacity-60"
                  >
