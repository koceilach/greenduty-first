      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-red-200 bg-white text-red-500 transition hover:-translate-y-0.5 hover:bg-red-50 hover:text-red-600 dark:border-red-800/50 dark:bg-slate-900 dark:text-red-400 dark:hover:bg-red-900/20"
            aria-label="Logout"
          >
